...
import 'package:bright_kid/ui/dashboard/home/activities_overview_details.dart';
...
class SeeCourseScreen3 extends StatefulWidget {
  ...
  @override
  _SeeCourseScreen3State createState() => _SeeCourseScreen3State();
}

class _SeeCourseScreen3State extends State<SeeCourseScreen3> {
  @override
  void initState() {
                      ...
                      CircularStepProgressIndicator(
                        ...
                        child: Center(
                          child: strokedText(
                              color: Colors.white,
                              fontSize: Get.width * .05,
                              text: '${widget.activitiesPercentage}%',
                          ...
                          child: Column(
                            children:
                              ...
                              return topicsCardForActivities(
                                  getActivitiesOverviewList[0],
                                  index,
                                  widget.data[index]['category_name'],
                                  widget.data[index]['activities'] == null ||
                                          widget
                                              .data[index]['activities'].isEmpty
                                      ? "0"
                                      : "${widget.data[index]['activities'].length}",
                                  widget.data);
                            }),
                          ),
                        ),
  ...
  Widget topicsCardForActivities(GetActivitiesOverviewModel model, int index,
      String name, String subtopics, var data) {
    model.images = [
    ...
    return GestureDetector(
      onTap: () {
        Get.to(() => ActivitiesOverViewDetailsScreen2(
              courseName: name,
              indexM: index,
              data: data,
              activityModel: model,
