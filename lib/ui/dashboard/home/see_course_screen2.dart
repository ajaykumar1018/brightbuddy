...
import 'package:bright_kid/ui/dashboard/home/course_topic_details2.dart';
...
class SeeCourseScreen2 extends StatefulWidget {
  ...
  @override
  _SeeCourseScreen2State createState() => _SeeCourseScreen2State();
}

class _SeeCourseScreen2State extends State<SeeCourseScreen2> {
  @override
  void initState() {
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            children:
                              ...
                              return topicsCardyash(
                                  widget.data[index]['chapter_name'],
                                  "${widget.data[index]['chapter_id']}",
                                  index,
                                  widget.data);
                            }),
                          ),
  ...
  Widget topicsCardyash(String name, String id, int index, var data) {
    List images = [
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            image: DecorationImage(
          image:
              AssetImage(images[images.length >= 6 ? index % 6 : index].image),
        )
            // boxShadow: [
            //   BoxShadow(
